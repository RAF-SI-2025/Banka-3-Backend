...
// Trading's OTC notifier still composes the Serbian templates locally;
// this sender hands the rendered message to the centralized dispatcher
// so SMTP credentials live in notification-svc rather than every
// service.
